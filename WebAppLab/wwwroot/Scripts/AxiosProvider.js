...
(function (App) {
    ...
    (function (AxiosProvider) {
        ...
        AxiosProvider.ClientesEliminar = function (ClientesId) { return ServiceApi.delete("api/Clientes/" + ClientesId).then(function (_a) {
            var data = _a.data;
            return data;
        }); };
        ...
        // export const UsuarioLogin = (entity) => axios.post<DBEntity>(entity + "Login").then(({ data }) => data);
